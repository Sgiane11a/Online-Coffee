...
<body class="bg-grape-950 text-white">
    <header class="sticky top-0 z-50 backdrop-blur-3xl border-azure-100 border-b-2">
        <nav
            class="flex justify-between items-center gap-2 font-bold text-lg lg:text-xl p-4 text-fuchsia-100">
            <span>
        ...
        <section class="flex justify-between gap-2 w-full ">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col items-center">
                    <svg aria-label="Imagen de Libro de Reclamaciones" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 16 16">
