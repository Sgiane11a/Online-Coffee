    ...
    <body class="flex h-screen bg-grape-950">
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    <x-admin-sidebar-button url="{{ route('admin.users.index') }}" text="Usuarios" icon="Users" />
                    <x-admin-sidebar-button url="{{ route('admin.store.index') }}" text="Tienda" icon="Tienda" />
                    <x-admin-sidebar-button url="{{ route('admin.forum.index') }}" text="Foro" icon="Forum" />
                </ul>
                <div class="px-6 my-6">
                    <button
        ...
        <aside
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <div class="px-6 my-6">
                    <button
                        class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-grape-600 border border-transparent rounded-lg active:bg-grape-600 hover:bg-grape-700 focus:outline-none focus:shadow-outline-grape">
                        Create account
                        <span class="ml-2" aria-hidden="true">+</span>
                    </button>
                </div>
        ...
        <div class="flex flex-col flex-1 w-full">
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div
                    class="container flex items-center justify-between h-full px-6 mx-auto text-grape-600 dark:text-grape-300">
                    <!-- Mobile hamburger -->
                    <button class="p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-grape"
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        <!-- Theme toggler -->
                        <li class="flex">
                            <button class="rounded-md focus:outline-none focus:shadow-outline-grape" @click="toggleTheme"
                        ...
                        <!-- Notifications menu -->
                        <li class="relative">
                            <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-grape"
