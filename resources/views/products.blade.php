...
<main class="">
    ...
    <div class="absolute top-0 right-16 w-full max-w-[350px]">
        <p class="px-4 py-4 text-xl text-black text-left">Encuentra una amplia selección de artículos esenciales para
            el hogar, cuidado personal, y más. Calidad y conveniencia en un solo lugar.</p>
        <div class="mt-3">
